                ...
                if (callback instanceof PasswordCallback) {
                    ...
                    if (password != null) {
                        ...
                        LOG.warn("Could not login: the {} is being asked for a password, but the ZooKeeper {}" +
                          " code does not currently support obtaining a password from the provider." +
                          " Make sure that the {} is configured to use a ticket provider (using" +
                          " the JAAS configuration setting 'useTicketCache=true)' and restart the {}. If" +
                          " you still get this message after that, the TGT in the ticket provider has expired and must" +
                          " be manually refreshed. To do so, first determine if you are using a password or a" +
                          " keytab. If the former, run kinit in a Unix shell in the environment of the provider who" +
                          ...
                          " <keytab> is the location of the keytab file). After manually refreshing your provider," +
                          " restart this {}. If you continue to see this message after manually refreshing" +
                          " your provider, ensure that your KDC host's clock is in sync with this host's clock.",
